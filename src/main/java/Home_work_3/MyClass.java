...
public class MyClass {
    ...
    public static void myMetod2(int[] a) {
        ...
        int t = a[0];
        if (a.length == 1) {
            System.out.println("Массив содержит только одно значение:" + a[0]);
        }
        ...
        System.out.println("Максимальное число массива:" + n);
        System.out.println("Минимальное число массива:" + t);
    }
}